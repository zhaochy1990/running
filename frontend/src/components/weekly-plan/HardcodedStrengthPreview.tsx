    ...
    exercises: [
      {
        name: "徒手深蹲",
        prescription: "12次 * 3组",
        imageUrl: "/strength_illustrations/output/T1061/v1.png",
      ...
      {
        name: "单腿硬拉抬膝",
        prescription: "每侧 8次 * 3组",
        imageUrl: "/strength_illustrations/output/T1144/v1.png",
      ...
      },
      {
        name: "仰卧臀桥",
        prescription: "12次 * 3组",
        imageUrl: "/strength_illustrations/output/T1132/v1.png",
      ...
      },
      {
        name: "保加利亚分腿蹲",
        prescription: "每侧 8次 * 3组",
        imageUrl: "/strength_illustrations/output/T1164/v1.png",
      ...
      {
        name: "单腿提踵",
        prescription: "每侧 12次 * 3组",
        imageUrl: "/strength_illustrations/output/T1275/v4.png",
      ...
      {
        name: "侧卧蚌式开合",
        prescription: "每侧 15次 * 3组",
        imageUrl: "/strength_illustrations/output/T1317/v1.png",
    ...
    exercises: [
      {
        name: "俯卧 I 字",
        prescription: "12次 * 3组",
        imageUrl: "/strength_illustrations/output/T1277/v1.png",
      ...
      },
      {
        name: "鸟狗平衡",
        prescription: "每侧 8次 * 3组",
        imageUrl: "/strength_illustrations/output/T1249/v1.png",
      ...
      },
      {
        name: "平板支撑",
        prescription: "40秒 * 3组",
        imageUrl: "/strength_illustrations/output/T1010/v1.png",
      ...
      {
        name: "死虫式",
        prescription: "每侧 10次 * 3组",
        imageUrl: "/strength_illustrations/output/T1243/v3.png",
      ...
      {
        name: "侧平板支撑",
        prescription: "每侧 30秒 * 3组",
        imageUrl: "/strength_illustrations/output/T1185/v1.png",
      ...
      },
      {
        name: "俯卧 Y 字",
        prescription: "12次 * 3组",
        imageUrl: "/strength_illustrations/output/T1278/v2.png",
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-4">
        {SESSIONS.map((session, index) => (
          <StrengthSessionCard key={session.title} session={session} index={index} initiallyExpanded={index === 0} />
        ))}
      </div>
            ...
            {session.exercises.map((exercise) => (
              <div key={exercise.name} className="rounded-xl bg-bg-secondary p-3">
                <p className="text-sm font-semibold text-text-primary">
                  {exercise.name} <span className="whitespace-nowrap font-mono text-xs text-accent-purple">{exercise.prescription}</span>
                </p>
                <div className={`mt-3 ${exercise.imageUrl ? "grid gap-10 md:grid-cols-[minmax(0,280px)_1fr] md:items-start" : ""}`}>
                  {exercise.imageUrl && (
                    <img
                      ...
                      loading="lazy"
                      className="mx-auto w-full max-w-sm rounded-lg border border-border-subtle bg-white md:max-w-[280px]"
                    />
                  )}
                  <div>
    ...
    <div className="mt-3">
      ...
      {inline ? (
        <div className="mt-1.5 flex flex-wrap gap-1.5">
          {items.map((item) => (
            <span key={item} className="rounded bg-accent-cyan/10 px-2 py-1 text-sm font-mono text-accent-cyan">
              {item}
            </span>
          ))}
        </div>

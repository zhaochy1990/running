  ...
  const fixedDays: readonly PlanDay[] = [
    {
      date: "2026-08-03",
      sessions: [
        session("2026-08-03", 0, "run", "慢跑 12K", 66 * 60, 12000, "建议配速 5:30/km；全程轻松可交谈，控制在 Z2，结束后做 5–10 分钟放松。"),
        session(
          "2026-08-03",
          1,
          "strength",
          ...
          65 * 60,
          null,
          "放在周一的慢跑之后完成；包含深蹲、单腿硬拉、臀桥、分腿蹲、小腿与髋稳定训练。",
        ),
      ],
      nutrition: nutrition("2026-08-03", 2800, 350, 140, 3500, "跑后先补碳水；力量训练结束后 1 小时内补充 30–35 g 蛋白质。"),
    },
    {
      date: "2026-08-04",
      sessions: [
      ...
      nutrition: nutrition("2026-08-04", 3000, 420, 140, 4000, "训练前 2–3 小时补充易消化碳水；训练后优先补碳水与 30 g 蛋白质。"),
    },
    {
      date: "2026-08-05",
      sessions: [session("2026-08-05", 0, "run", "恢复跑 6–8K", null, null, "低强度恢复，按体感选择 6–8K；腿部沉重时缩短距离。")],
      nutrition: nutrition("2026-08-05", 2500, 280, 130, 3000, "跑后补充一份碳水 + 蛋白质加餐，全天均匀补水。"),
    },
    {
      date: "2026-08-08",
      sessions: [
        session(
          ...
          2 * 3600 + 14 * 60 + 35,
          28000,
          "训练目的：提高有氧基础。\n热身内容：胫骨拉伸、抱提膝、动态弓箭步、动态侧弓步、原地小跳、直腿跑、马克 A、小步跑、后踢腿。\n训练后拉伸：胫骨拉伸、最伟大拉伸、股四头肌拉伸、侧弓步拉伸、臀部拉伸、阔筋膜张肌拉伸、上肢拉伸。\n训练说明：分段执行：0–5km @ 5:00/km；5–10km @ 4:55/km；10–15km @ 4:50/km；15–20km @ 4:45/km；20–25km @ 4:40/km；25–28km @ 4:35/km。预计总用时约 2:14:35。渐加速指每段配速比前一段快 5秒/km。前段严格克制，后段以动作稳定为先；若出现疼痛、动作变形或 RPE 达到 8，停止提速并按轻松强度完成或提前结束。长距离中同步练习补水与能量胶补给。",
        ),
      ],
      nutrition: nutrition(
        "2026-08-08",
        ...
        140,
        4500,
        "跑前 2–3 小时补充 70–140 g 碳水；跑中每小时 30–60 g 能量胶、饮水 400–800 ml，搭配盐丸和电解质饮料；跑后 1 小时内补充碳水 70–85 g + 蛋白质 25–30 g。",
      ),
    },
  ];
      ...
      return {
        ...
        sessions: [
          ...
          session(
            ...
            60 * 60,
            null,
            "强化上背、核心抗伸展与抗旋转；包含俯卧 I/Y 字、鸟狗、平板、死虫与侧平板。",
          ),
        ],

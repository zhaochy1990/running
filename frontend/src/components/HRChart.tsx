...
export default function HRChart({ data, startTs: startTsProp, hoverElapsed, onHover }: Props) {
  ...
  const hoverText = hoverElapsed != null ? `${formatTime(hoverElapsed)}  ${hoverPoint?.hr ?? "—"} bpm` : "";
    ...
    <ResponsiveContainer width="100%" height={200}>
      ...
      >
        ...
        <ReferenceLine
          ...
          strokeDasharray="4 4"
          strokeOpacity={0.6}
          label={{ value: `avg ${avgHR}`, position: "right", fill: "#d32f2f", fontSize: 10, fontFamily: "JetBrains Mono" }}
        />
        {hoverElapsed != null && (

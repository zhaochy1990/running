...
describe("WorkspaceLayout", () => {
  ...
  it("keeps review and chat in independent scroll regions on desktop", () => {
    ...
    expect(screen.getByTestId("coach-workspace-review-scroll")).toHaveClass("lg:overflow-y-auto");
    expect(screen.getByTestId("coach-workspace-chat-scroll")).toHaveClass("min-h-0", "flex-1");
  });

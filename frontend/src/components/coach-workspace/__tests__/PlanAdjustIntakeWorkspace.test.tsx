...
describe("PlanAdjustIntakeWorkspace", () => {
  it('titles the weekly intake "调整训练周" (not "本周")', () => {
    render(
      <PlanAdjustIntakeWorkspace kind="weekly" currentPlanSummary="7/27 — 8/2 · 计划跑量 105.3 km · 7 训练课" chat={<div data-testid="chat">chat</div>} />,
    );
  ...
  it("keeps the master intake title unchanged", () => {
    render(<PlanAdjustIntakeWorkspace kind="master" currentPlanSummary="上海马拉松 · 第 7/16 周 · 版本 v4" chat={<div data-testid="chat">chat</div>} />);

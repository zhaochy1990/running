...
import type { ApplyOutcome, ApplyProposalRequest, MasterDiffProposal, StashedProposal } from "./types";
 ...
 */
export function MasterPlanAdjustWorkspace({ stashed, currentPlanSummary, onApply, onDiscard, chat, onApplied }: MasterPlanAdjustWorkspaceProps) {
    ...
    <WorkspaceLayout title="调整赛季计划" chat={chat}>
      <section className="space-y-4">
        <div className="rounded-lg border border-border-subtle bg-bg-card p-4">
          <div className="text-xs font-medium uppercase tracking-wide text-text-muted">当前赛季计划</div>

...
import { clearStashedProposal, readStashedProposal, stashProposal } from "../coachProposalStorage";
import type { ProposalTargetKey, StashedProposal, WeeklyDiffProposal } from "../../components/coach-workspace/types";

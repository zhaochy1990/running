...
import { getCurrentMasterPlan, type CurrentSeasonPlan, type SeasonPlanContent } from "../../api";
...
function renderPlanPageWithCoach(coachChat: boolean) {
  return render(
    <UserContext.Provider value={{ user: "user-1", displayName: "Runner", coachChat, refresh: async () => {} }}>
      <MemoryRouter initialEntries={["/plan"]}>
        <Routes>
          <Route path="/plan" element={<TrainingPlanPage />} />

  ...
  it("submits payload and calls onSaved on success", async () => {
    const upsertSpy = vi.spyOn(api, "upsertBodyComposition").mockResolvedValue({
      ...
      data: {
        ...
        leg_fat_delta: null,
        arm_smm_delta: null,
        upper_lower_smm_ratio: null,
        left_arm_smm_kg: null,
        right_arm_smm_kg: null,
        trunk_smm_kg: null,
        left_leg_smm_kg: null,
        right_leg_smm_kg: null,
        left_arm_fat_kg: null,
        right_arm_fat_kg: null,
        trunk_fat_kg: null,
        left_leg_fat_kg: null,
        right_leg_fat_kg: null,
        left_arm_lean_pct_std: null,
        right_arm_lean_pct_std: null,
        trunk_lean_pct_std: null,
        left_leg_lean_pct_std: null,
        right_leg_lean_pct_std: null,
        left_arm_fat_pct_std: null,
        right_arm_fat_pct_std: null,
        trunk_fat_pct_std: null,
        left_leg_fat_pct_std: null,
        right_leg_fat_pct_std: null,
      },
    } as never);
    const onSaved = vi.fn();
    renderModal({ onSaved });

    ...
    <section className="reverse" id="reverse">
      <div className="wrap">
        <div className="sec-head reveal" ref={secHeadRef}>
          ...
          <p>
            我们认为周期化,才是系统性变强的底层逻辑。定下你的目标赛事和成绩,STRIDE帮你生成系统性、周期化的训练计划，分几个阶段，每个阶段该练什么、练到什么程度,都帮你精确地安排在抵达终点的路上。
          </p>
        </div>
        ...
        <div className="rev-card reveal" ref={revCardRef}>
          <div className="rev-head">
            <div className="rev-goal">
              ...
              <div className="gv">
                西安马拉松（2026夏训） · <em>目标 3:30:00</em>
              </div>
            </div>
            <div className="rev-goalmeta">
              <div className="m">
                <div className="v g">
                  26<span style={{ fontSize: "11px", color: "#7a8092" }}>周</span>
                </div>
                <div className="l">距离比赛</div>
              </div>
              <div className="m">
                <div className="v">10/18</div>
                <div className="l">比赛日</div>
              </div>
              <div className="m">
                <div className="v">
                  42.2<span style={{ fontSize: "11px", color: "#7a8092" }}>K</span>
                </div>
                <div className="l">距离</div>
              </div>
            </div>
          </div>
          ...
          <div className="rev-chart-head">
            ...
            <div className="rch-peak">
              峰值 <b>72</b>
              <span>km</span> · W21 · 巅峰期
            </div>
          </div>
          ...
          <div className="rev-mileage" ref={mileageRef}>
            {WEEK_KM.map((v, i) => {
              ...
              return (
                <div key={i} className={`mb ${phase}`} style={{ height: `${h}%` }} title={`W${String(i + 1).padStart(2, "0")} · ${v} km`}>
          ...
          <div className="rev-legend">
            <span>
              <i className="sw base"></i>基础期 · 7周
            </span>
            <span>
              <i className="sw speed"></i>速度训练 · 6周
            </span>
            <span>
              <i className="sw marathon"></i>马拉松专项 · 6周
            </span>
            <span>
              <i className="sw peak"></i>巅峰期 · 4周
            </span>
            <span>
              <i className="sw taper"></i>减量期 · 2周
            </span>
            <span>
              <i className="sw race"></i>比赛周
            </span>
          </div>
          ...
          <div className="rev-foot">
            ...
            <span>
              赛事变了、状态变了,整条时间轴会<b>自动重排</b>——你永远走在通往终点的最优路径上。
            </span>
          </div>
        </div>
      </div>

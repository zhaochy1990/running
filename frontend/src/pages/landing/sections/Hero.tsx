      ...
      <div className="hero-in wrap">
        <div>
          <span className="hero-badge">
            <span className="dot"></span>系统 · 全面 · 为你而生
          </span>
          <h1>
            每一步都有数据
            <br />
            <span className="grad">每一份计划都属于你</span>
          </h1>
          <p className="lede">
            STRIDE 把<b>跑步、力量、饮食</b>拧成一套完整系统,读懂你的身体、<b>为你量身定制</b>——系统、全面、只属于你。每一天,都在把你练成<b>更强的自己</b>。
          </p>
          <div className="hero-actions">
            <button type="button" className="big-cta" onClick={onLogin}>
              免费开始训练
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
                <path d="M5 12h14M13 6l6 6-6 6"></path>
              </svg>
            </button>
            <a className="ghost-cta" href="#reverse">
              往下看怎么练 ↓
            </a>
          </div>
        </div>
        ...
        <div className="hero-card reveal" ref={cardRef}>
          ...
          <div className="hc-metrics">
            <div className="hc-m">
              <div className="l">本周里程</div>
              <div className="v green">{mileage}</div>
            </div>
            <div className="hc-m">
            ...
            <div className="hc-m">
              <div className="l">训练负荷</div>
              <div className="v">{load}</div>
            </div>
          </div>
          <div className="hc-chart">
            ...
            <div className="hc-bars">
              {HERO_BAR_HEIGHTS.map((h, i) => (
                <span key={i} style={{ height: `${h}%`, animationDelay: `${2 + i * 0.05}s` }}></span>
              ))}
            </div>
          </div>
        </div>

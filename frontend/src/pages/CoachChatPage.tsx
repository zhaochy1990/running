...
export default function CoachChatPage() {
  return (
    <div data-testid="coach-chat-page" className="flex h-full w-full max-w-none flex-col py-6">
      <header className="flex-shrink-0 px-4 sm:px-8 lg:px-10 xl:px-12">
        ...
        <p className="mt-1 text-sm text-text-muted">向 Coach 提问、请求解释或复盘；对话可以引用计划，但不会直接改变计划。</p>
      </header>

...
import { NOTIFICATIONS, type AppNotification, fromServerNotification } from "../data/notifications";
...
function markServerNotificationRead(notifications: AppNotification[], readIds: Set<string>): AppNotification[] {

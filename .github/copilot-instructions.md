...
- Weekly feedback is read and written through Go/MySQL `weekly_feedback`. Activity `sport_note`/`feel_type` remain activity-level data and are never appended into weekly feedback.

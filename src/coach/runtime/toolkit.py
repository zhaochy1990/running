...
A ``Toolkit`` aggregates implementations of all 32 callable tools. Adapters
...
class Toolkit(Protocol):
    """All 32 tools surfaced as attributes for direct callable access."""

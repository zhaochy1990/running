...
A ``Toolkit`` aggregates implementations of all 29 callable tools. Adapters
...
class Toolkit(Protocol):
    """All 29 tools surfaced as attributes for direct callable access."""

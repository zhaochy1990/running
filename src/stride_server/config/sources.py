...
_ENV_MAPPING: dict[str, tuple[str, str]] = {
    ...
    "STRIDE_JOBS_TABLE_ACCOUNT_URL": ("storage.jobs.table_account_url", "str"),
    "STRIDE_JOBS_TABLE_NAME": ("storage.jobs.jobs_table_name", "str"),
    "STRIDE_JOBS_FILE_BACKEND_DIR": ("storage.jobs.file_backend_dir", "str"),
    "STRIDE_JOBS_VISIBILITY_TIMEOUT_S": ("storage.jobs.visibility_timeout_s", "int"),
    "STRIDE_JOBS_POISON_MAX_ATTEMPTS": ("storage.jobs.poison_max_attempts", "int"),
    "STRIDE_JOBS_STALE_AFTER_SECONDS": ("storage.jobs.stale_after_seconds", "int"),
    "STRIDE_DATABASE_MODE": ("storage.database.mode", "str"),
    "STRIDE_DATABASE_HOST": ("storage.database.host", "str"),
    "STRIDE_DATABASE_PORT": ("storage.database.port", "int"),
    "STRIDE_DATABASE_NAME": ("storage.database.database", "str"),
    "STRIDE_DATABASE_USERNAME": ("storage.database.username", "str"),
    "STRIDE_DATABASE_PASSWORD": ("storage.database.password", "str"),
    "STRIDE_DATABASE_TLS_CA_PATH": ("storage.database.tls_ca_path", "str"),
    "STRIDE_DATABASE_DUAL_WRITE_ENABLED": ("storage.database.dual_write_enabled", "bool"),
    "STRIDE_DATABASE_MYSQL_READ_ALL": ("storage.database.mysql_read_all", "bool"),
    "STRIDE_DATABASE_POOL_SIZE": ("storage.database.pool_size", "int"),
    "STRIDE_DATABASE_MAX_OVERFLOW": ("storage.database.max_overflow", "int"),
    "STRIDE_DATABASE_POOL_TIMEOUT_S": ("storage.database.pool_timeout_s", "int"),
    "STRIDE_DATABASE_POOL_RECYCLE_S": ("storage.database.pool_recycle_s", "int"),
    "STRIDE_DATABASE_CONNECT_TIMEOUT_S": ("storage.database.connect_timeout_s", "int"),
    "STRIDE_DATABASE_READ_TIMEOUT_S": ("storage.database.read_timeout_s", "int"),
    "STRIDE_DATABASE_WRITE_TIMEOUT_S": ("storage.database.write_timeout_s", "int"),

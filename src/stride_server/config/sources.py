...
_ENV_MAPPING: dict[str, tuple[str, str]] = {
    ...
    "STRIDE_COACH_CHAT_USERS": ("plan.coach_chat_users", "str"),
    "STRIDE_COACH_CHAT_DEBUG_USERS": ("plan.coach_chat_debug_users", "str"),
    "STRIDE_COACH_CHAT_MAX_MESSAGE_CHARS": ("plan.coach_chat_max_message_chars", "int"),

...
3. 专项速度周期（Speed Phase）：针对速度薄弱的跑者，进一步提高训练强度，加入更多的速度训练，重点是提高跑步效率和跑步的绝对速度能力，速度周期通常在基础期之后进行，通常作为夏季炎热天气下的阶段性训练，用于规避炎热天气下的长距离大跑量训练。这个阶段力量训练以绝对力量的增长为主。
4. 马拉松专项期（Marathon Phase）：在提升期的基础上，进一步提高训练强度和比赛模拟训练，重点是比赛节奏训练和长距离跑。力量训练以维持为主，避免过度疲劳。这个阶段是最重要的阶段，通常需要至少 3-4 周的时间来适应比赛节奏和比赛强度。
5. 赛前减量期（Taper Phase）：这个周期一般时长2周，其中第二周为比赛周，从第一周逐步减少训练量，但需要保持训练强度（减跑量不减跑步强度），调整身体状态，确保身体充分恢复，为比赛做好准备，比赛周赛前训练量应该比赛前减量期的第一周训练量减少20%-30%，注意不要把比赛本身的负荷计算进去。对于全马比赛，赛前减量期的第一周长距离通常不超过25km，对于半马比赛，赛前减量期的第一周长距离训练通常不超过15km。
6. 赛后恢复期（Recovery Phase）：这个周期一般时长2周，比赛结束后，进行主动恢复，调整训练计划，恢复身体状态。

	...
	phases: [
		{
			...
			end_date: "2026-10-18",
			focus:
				"Demonstrate the Kernel seam; planning quality arrives in follow-up slices.",
			...
			key_sessions: [
				{
					...
					intensity: "goal race",
					purpose:
						"Demonstrate a strategic key session through the Kernel seam",
				},
			],

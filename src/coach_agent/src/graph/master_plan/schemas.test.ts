...
test("embedded race-pace long runs cannot be duplicated as race-pace sessions", () => {
  ...
  const invalidPlan = {
    ...
    weeks: [{
      ...plan.weeks[0],
      key_sessions: [
        { type: "long_run", distance_km: 30, duration_min: null, intensity: "easy + 10km MP", purpose: "race-specific endurance" },
        { type: "race_pace", distance_km: 10, duration_min: null, intensity: "MP", purpose: "race pace" },
      ],
    }],
  };

...
type jobModel struct {
	...
	PartitionKey  string     `gorm:"column:partition_key;type:varchar(191);index:idx_jobs_partition;not null"`
...
type pipelineRunModel struct {
	...
	PartitionKey string     `gorm:"column:partition_key;type:varchar(191);index:idx_runs_partition;not null"`

...
const docTemplate = `{
    ...
    "paths": {
        "/api/admin/async-runs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by pipeline name or job type",
                        "name": "name",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.asyncRunsAdminResponse"
                        }
                    },
                    "401": {
        ...
        "/api/admin/cities/{city}/content": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "City name (race_calendar.city spelling, e.g. 厦门市)",
                        "name": "city",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.raceCityContentInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/cities/{city}/content/ai-draft": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/admin/pipeline-runs": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by run status (queued|running|done|failed)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.pipelineRunsAdminResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/internal/jobs": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Job row to persist",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.createInternalJobRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Existing job for a repeated idempotency key",
                        "schema": {
                            "$ref": "#/definitions/api.createInternalJobResponse"
                        }
                    },
                    "201": {
                        "description": "Created",
        ...
        "/api/internal/jobs/stale-running": {
            "post": {
                "security": [
                    {
                        "InternalToken": []
                ...
                "parameters": [
                    {
                        "description": "Reconcile window and error code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.staleRunningRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/internal/jobs/{job_id}/transition": {
            "post": {
                "security": [
                    {
                        "InternalToken": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.jobTransitionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.bodyCompositionReadinessResponse"
                        }
                    }
                }
            }
        ...
        "/api/users/{user_id}/master-plan": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Replacement content and the confirmed active plan identity",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.updateMasterPlanRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.updateMasterPlanResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/users/{user_id}/master-plan/current": {
            "get": {
                "security": [
                    {
                        "InternalToken": []
        ...
        "/api/users/{user_id}/master-plan/drafts": {
            "get": {
                "security": [
                    {
                        "InternalToken": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Draft id and structured content",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.insertMasterPlanDraftRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.draftIDResponse"
                        }
                    },
                    "201": {
                        "description": "Created",
        ...
        "/api/users/{user_id}/master-plan/drafts/{plan_id}": {
            "get": {
                "security": [
                    {
                        "InternalToken": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.masterPlanDraftResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/users/{user_id}/master-plan/drafts/{plan_id}/abandon": {
            "post": {
                "security": [
                    {
                        "InternalToken": []
        ...
        "/api/users/{user_id}/master-plan/drafts/{plan_id}/activate": {
            "post": {
                "security": [
                    {
                        "InternalToken": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.activateMasterPlanDraftResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/{user}/ability/backfill": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Days to backfill 7–365 (default 180)",
                        "name": "days",
                        "in": "query"
                    }
                ],
        ...
        "/api/{user}/ability/current": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Force a live compute",
                        "name": "refresh",
                        "in": "query"
                    }
                ],
        ...
        "/api/{user}/ability/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Window 1–365 (default 90)",
                        "name": "days",
                        "in": "query"
                    }
                ],
        ...
        "/api/{user}/activities/{label_id}/ability": {
            "get": {
                "security": [
                    {
                        "InternalToken": []
        ...
        "/api/{user}/body-composition": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Only return scans from the most recent N days (1-3650)",
                        "name": "days",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.bodyCompositionListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.bodyCompositionScanInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.bodyCompositionScanDTO"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/{user}/body-composition/summary": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.bodyCompositionSummaryResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/{user}/body-composition/{scan_date}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.pbsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.weeklyPlanDraftResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/{user}/plan/drafts/{plan_id}/abandon": {
            "post": {
                "security": [
                    {
                        "InternalToken": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.weeklyDraftIDResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/{user}/plan/drafts/{plan_id}/activate": {
            "post": {
                "security": [
                    {
                        "InternalToken": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.activateWeeklyPlanDraftResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/{user}/plan/weeks/{weekName}/drafts": {
            "post": {
                "security": [
                    {
                        "InternalToken": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.insertWeeklyPlanDraftRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/{user}/race-predictions/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Window 1–365 (default 180)",
                        "name": "days",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.weekDetailResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "api.activateMasterPlanDraftResponse": {
            "type": "object",
            "properties": {
                "plan": {
                    "$ref": "#/definitions/api.currentSeasonPlanEnvelope"
        ...
        "api.activateWeeklyPlanDraftResponse": {
            "type": "object",
            "properties": {
                "plan": {
                    "$ref": "#/definitions/api.weeklyPlanDetailResponse"
        ...
        "api.asyncRunsAdminResponse": {
            ...
            "properties": {
                ...
                "runs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.asyncRunResponse"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "api.bodyCompositionListResponse": {
            "type": "object",
            "properties": {
                "scans": {
                    "type": "array",
        ...
        "api.bodyCompositionReadinessResponse": {
            "type": "object",
            "properties": {
                "contract_version": {
                    "type": "string"
        ...
        "api.bodyCompositionScanDTO": {
            ...
            "properties": {
                ...
                "left_arm_fat_pct_std": {
                    "type": "number"
                },
                "left_arm_lean_pct_std": {
                    "type": "number"
                },
                "left_arm_smm_kg": {
                    "description": "Derived — per-segment flat fields (for easy chart access)",
                    "type": "number"
                },
                "left_leg_fat_kg": {
                    "type": "number"
                },
                "left_leg_fat_pct_std": {
                    "type": "number"
                },
                "left_leg_lean_pct_std": {
                    "type": "number"
                },
                "left_leg_smm_kg": {
                    "type": "number"
                ...
                "leg_smm_delta": {
                    "description": "Derived — deltas / ratios",
                    "type": "number"
                },
                "protein_kg": {
                    "type": "number"
                ...
                "right_arm_fat_pct_std": {
                    "type": "number"
                },
                "right_arm_lean_pct_std": {
                    "type": "number"
                },
                "right_arm_smm_kg": {
                    "type": "number"
                ...
                "right_leg_fat_pct_std": {
                    "type": "number"
                },
                "right_leg_lean_pct_std": {
                    "type": "number"
                },
                "right_leg_smm_kg": {
                    "type": "number"
                ...
                "segments": {
                    "description": "Segments array (repeated data, matches Python contract)",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.bodyCompositionSegmentDTO"
                    }
                },
                "smi": {
                    "type": "number"
        ...
        "api.bodyCompositionScanInput": {
            ...
            "properties": {
                ...
                "segments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.bodyCompositionSegmentInput"
                    }
                },
                "smi": {
                    "type": "number"
        ...
        "api.bodyCompositionSegmentInput": {
            "type": "object",
            "required": [
                "fat_mass_kg",
                "lean_mass_kg",
        ...
        "api.bodyCompositionSummaryResponse": {
            "type": "object",
            "properties": {
                "checkpoints": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.PhaseCheckpoint"
                    }
                },
                "deltas": {
                    "$ref": "#/definitions/api.bodyCompositionDeltasDTO"
                },
                "latest": {
                    "$ref": "#/definitions/api.bodyCompositionScanDTO"
                }
        ...
        "api.createInternalJobResponse": {
            "type": "object",
            "properties": {
                "created": {
                    "description": "Created is false when the idempotency key resolved to an existing job.",
                    "type": "boolean"
                },
                "job_id": {
                    "type": "string"
        ...
        "api.insertMasterPlanDraftRequest": {
            "type": "object",
            "required": [
                "content",
                "draft_id"
        ...
        "api.insertWeeklyPlanDraftRequest": {
            "type": "object",
            "required": [
                "content",
                "draft_id"
        ...
        "api.pbsResponse": {
            ...
            "properties": {
                ...
                "pbs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.pbEntryDTO"
                    }
                },
                "user_id": {
                    "type": "string"
        ...
        "api.raceContentItemDTO": {
            ...
            "properties": {
                "aid_stations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/storage.RaceAidStation"
                    }
                },
                "cutoffs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/storage.RaceCutoff"
                    }
                },
                "distance_km": {
                    "type": "number"
                ...
                "photos": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/storage.RacePhoto"
                    }
                },
                "prizes": {
                    "type": "array",
        ...
        "api.weekDetailResponse": {
            "type": "object",
            "properties": {
                "activities": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.weekActivityResponse"
                    }
                },
                "activity_count": {
                    "type": "integer"

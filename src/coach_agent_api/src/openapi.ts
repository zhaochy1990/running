export const OPENAPI_DOCUMENT = {
	...
	info: {
		...
		version: "0.1.0",
		description:
			"Authenticated HTTP composition root for the STRIDE Coach Agent.",
	},
	tags: [
		...
		"/api/users/me/coach/chat": {
			post: {
				...
				responses: {
					...
					"409": errorResponse(
						"The client_turn_id was already used with different input.",
					),
					"429": {
						...errorResponse(
							"The thread is busy; retry after the indicated delay.",
						),
						headers: {
							"Retry-After": {
